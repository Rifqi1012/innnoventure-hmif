                ...
                <div className="relative z-10 p-8 sm:p-12">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div>
                                <label className="block text-sm font-bold text-slate-700 mb-2">Live Demo URL (Hosting)</label>
                                <input type="url" name="link_hosting" required className="w-full px-5 py-3.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-slate-900 transition-all outline-none" placeholder="https://..." onChange={handleChange} />
                            </div>
                        </div>
